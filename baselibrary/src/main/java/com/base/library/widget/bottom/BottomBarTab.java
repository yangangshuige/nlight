package com.base.library.widget.bottom;
...
import com.base.library.utils.ContextUtils;
...
public class BottomBarTab extends LinearLayout {
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.app_theme));
            mTextView.setTextColor(ContextCompat.getColor(mContext, R.color.app_theme));
