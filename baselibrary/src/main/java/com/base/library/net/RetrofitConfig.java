...
public class RetrofitConfig {
    ...
    public static final Interceptor sRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetUtil.isNetworkAvailable(BaseApp.getInstance())) {
    ...
    public static final Interceptor sQueryParameterInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            HttpUrl modifiedUrl = originalRequest.url().newBuilder()
                    .addQueryParameter("v", PackageUtils.getVersionName(BaseApp.getInstance()))
                    .addQueryParameter("device", "android")
                    .addQueryParameter("ttid", "1")
                    .addQueryParameter("sign", SecurityUtils.getSign())
                    .build();
...
//            Log.w(TAG, response.body().string());
    ...
    public final static CustomGsonConverter converter = CustomGsonConverter.create(new GsonBuilder()
            .disableHtmlEscaping()
            .setLenient()
            .create());
    @NonNull
